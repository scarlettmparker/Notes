...
const AltText = ({ alt, style }: { alt: string, style?: string }) => {
    return (
        <span class={`absolute z-20 bottom-full ${LM_ALIGN} whitespace-nowrap mb-1 py-0.5 px-1.5 bg-thunder text-white text-sm font-['Open_Sans'] rounded-md select-none flex items-center justify-center ${style}`}>
            {alt}
        </span>
    )
}
